...
if (!$session->isAdmin()) {
    ...
    <html>
        ...
        <tr><td>
                ...
                ?>
			<div class="panel panel-primary">
				<div class="panel-heading">Blokuoti vartotojai:</div>
				</div>
                <?php
                displayBannedUsers();
                ?>
                ...
                <tr><td> 
					<div class="panel panel-primary">
				<div class="panel-heading">Šiuo metu prisijungę vartotojai:</div>
				</div>
                        <?php
                        ViewActiveUsers();
                        ?>
        ...
        <tr>
            <td>
				...
				<div class="panel-heading">Šalinti neaktyvius vartotojus</div>
				</div>
                <table>
